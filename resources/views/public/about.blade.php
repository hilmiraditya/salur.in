...
<div class="container">
  <br>
  <h2 class="display-4">Selamat Datang di Salur.in!</h2>
  <br>
  ...
  <hr class="my-4">
  <div id="kontak">
  <i class="fas fa-home fa-lg fa-fw"></i> Alamat : Jl. Krusty Krab, Bikini Bottom<br>
  <i class="fas fa-globe fa-lg fa-fw"></i> Web: www.salur.in<br>
  <i class="fas fa-envelope fa-lg fa-fw"></i> Email : contact.salur.in@gmail.com<br>
